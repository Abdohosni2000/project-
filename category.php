	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			...
			<div>
				...
				if (isset($userid)){ ?>
					<form action="user_recommandition.php" method="get" style="    display: flex;
					...
					margin-top: -40px;">
                        ...
                        <input type="submit"  value="show_recommandition" class="submit-button">
                    </form>	
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<form id="product-form" action="user_form.php" method="post">
							<!-- <label for="product">Choose a product:</label> -->
							 <input type="text" name="user_id" style="display: none;" value="<?php  echo $userid; ?>">
							<select id="product" name="amount" style="display: none;">
									<option value="<?php echo $row['productPrice']; ?>"><?php echo $row['productName']; ?></option>
							</select>
						...
						<li>
							...
							if (isset($userid)){
								...
								if ($result) {
									while ($product = mysqli_fetch_assoc($result)) {?>
										...
										<form  method="post">
											...
											<input type="hidden" name="moive_name" value="<?php echo $row['productName'];?>" >
											<input type="hidden" name="image" value="<?php echo $row['productImage1'];?>" >

											<input type="text" name="moive_rateing"  placeholder="rating">
											<input type="submit" value="rating" name="submit">
										</form>
								...
								if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
									// Get form data
									$user_id = $_POST['id'];
									$moive_name = $_POST['moive_name'];
									$image = $_POST['image'];
									$moive_rateing = $_POST['moive_rateing'];
								
									// SQL query to insert data into users_movies table
									$query = "INSERT INTO users_movies (user_id, moive_name, image, moive_rateing) VALUES ('$user_id', '$moive_name', '$image', '$moive_rateing')";
